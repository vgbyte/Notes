...
- [React](#react)
  - [Intro](#intro)
    ...
    - [Difference between JSX and HTML](#difference-between-jsx-and-html)
    - [Stateless Functional Component](#stateless-functional-component)
    - [Class Component](#class-component)
    - [Component with Composition](#component-with-composition)
    ...
    - [Stateless and Statefull](#stateless-and-statefull)
    ...
    - [Use Array.map() to Dynamically Render ElementsPassed](#use-arraymap-to-dynamically-render-elementspassed)
